...
import { CalendarCheck, CalendarDays, ChevronLeft, ChevronRight, CircleUserRound, Clock, Gauge, LayoutGrid, ListChecks, MessagesSquare, Settings, Users } from "lucide-react";
...
export function Sidebar() {
  ...
  const administrationItems = user?.role.name === "SUPER_ADMIN"
    ? [{ href: "/users", label: "Accounts", meta: "Provisioning", icon: Users, tone: "coral" as const }]
    : [];

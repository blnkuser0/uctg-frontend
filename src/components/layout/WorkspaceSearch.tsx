...
export function WorkspaceSearch() {
  ...
  const results = useMemo(() => {
    const adminDestination: SearchResult[] = user?.role.name === "SUPER_ADMIN"
      ? [{ label: "Accounts", detail: "Provision users and organizations", href: "/users", group: "Page", icon: Users }]
      : [];
